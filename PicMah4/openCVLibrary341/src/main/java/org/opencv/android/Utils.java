...
public class Utils {
    ...
    public static Mat loadResource(Context context, String resourceId) throws IOException
    {
        return loadResource(context, resourceId, -1);
    }

    public static Mat loadResource(Context context, String resourceId, int flags) throws IOException
    {
        InputStream is = (InputStream) context.getResources().openRawResource(Integer.parseInt (resourceId));
